...
import LightThemeForcer from '@/components/LightThemeForcer';
...
const AssetEntry = () => {
  ...
  useEffect(() => {
    const forceLightTheme = () => {
      ...
      console.log('🌞 [AssetEntry] Light theme forced');
    };
  ...
  return (
    <LightThemeForcer className="min-h-screen bg-white">
      <div 
      ...
      >
        ...
        {/* Main Form Card */}
        <Card 
          className="shadow-lg border-green-100 bg-white"
          style={{ 
            backgroundColor: '#ffffff', 
            borderColor: '#dcfce7',
            color: '#111827'
