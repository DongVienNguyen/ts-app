import{s as h}from"./index-DpfqfBid.js";import{f as i}from"./emailUtils-C-rUDXQT.js";const r=async s=>{try{if(!s.to||s.to.length===0)return{success:!1,error:"Recipient list cannot be empty.",message:"Không thể gửi email: Danh sách người nhận trống."};console.log("Sending email via Edge Function:",s);const{data:n,error:t}=await h.functions.invoke("send-notification-email",{body:s});return console.log("Edge Function response:",{data:n,error:t}),t?(console.error("Edge Function invocation error details:",t),{success:!1,error:`Lỗi gửi email từ Edge Function: ${t.message||JSON.stringify(t)}`,message:"Không thể gửi email"}):n&&!n.success?(console.error("Email service error:",n),{success:!1,error:`Lỗi từ dịch vụ email: ${n.error||"Lỗi không xác định"}`,message:n.message||"Không thể gửi email",data:n}):(console.log("Email sent successfully:",n),{success:!0,data:n,message:"Email đã được gửi thành công"})}catch(n){return console.error("Error in sendEmail:",n),{success:!1,error:n instanceof Error?n.message:"Lỗi không xác định",message:"Không thể gửi email"}}},c=async(s,n,t)=>{const e=`
